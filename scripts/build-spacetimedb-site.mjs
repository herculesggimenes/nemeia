...
${section("example","07","End-to-end information flow","A World Master assigns two inspection missions to Navigator. Follow their descriptions and objectives through Unit observations, durable world state, agent context, recovery and validated progress.",`<div class="example-list">${exampleRows.map(([id,title,summary,description],i)=>codeRow("example",i,title,summary,description,v0FlowCode[id],`flow-${id}`)).join("\n")}</div>`)}
