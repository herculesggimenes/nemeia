...
export const ObjectiveCriterion = t.enum("ObjectiveCriterion", {
  ...
  approached: t.object("ApproachedCriterion", {
    targetId: t.string(), // required outcome target; the assigned agent chooses an eligible Unit
...
export const inspectionSpec: MissionSpec = {
  ...
  template: undefined, deadlineAt: undefined, // hardware policy belongs to installed action bindings, not the mission
  objectives: [
    ...
    { id: "approach", description: "Reach the measured standoff", dependsOn: ["geometry", "semantics"], optional: false,
      criterion: { tag: "approached", value: { targetId: "backpack-A", standoffM: 0.8 } } },
